...
# 🦁 XXD Panel 088｜قصيدة تشكيل الحروف

### يجعل اللغة نفسها تنمو إلى صورة تجريبية
...
تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. ولّد Panel 088 كل عمل بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر. تستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.

<!-- xxd-human-intro:start -->
## ما الذي يحله هذا الأسلوب؟

يحوّل الرسم ذي المحيط الكامل الموضوع إلى صورة عادية، بينما لا يترك سحاب الحروف سوى ضجيج عشوائي؛ لا يجعل أيٌّ منهما اللغة بنيةً للصورة.

يجعل **Panel 088** الكلمات الكاملة والحروف والحروف الصينية والأرقام وعلامات الترقيم وشظايا النص ومصفوفات النقاط نفسها موادَّ للتشكيل. من بعيد يظهر موضوع الصورة بوضوح، ومن قرب يتضح أن المحيط والمناطق الداكنة والوزن والملمس مبنية من حروف صاغتها الكثافة والحجم والاتجاه والدوران والتباعد والتراكب.

### مناسب لـ

- جعل الكلمات المقروءة والحروف المنفردة وعلامات الترقيم والنقاط هي الموضوع نفسه، لا عنواناً مضافاً؛
- بناء تركيب تفكيكي يجمع الحروف في الظلال ويفتح مسافاتها في الضوء، مع إبقاء المحيط الأساسي واضحاً؛
- صنع شعر بصري بتدرج كثافة الحروف والأشكال الموجبة والسالبة والتوتر الاتجاهي والفراغ الواسع، من دون التحول إلى ضجيج عشوائي؛
- مخرجات أعلى–أسفل ويسار–يمين وتصميم فقط ونسب متعددة وحزم خلفيات ومعالجة المجلدات.

### بداية سريعة

> استخدم XXD Panel 088 لمعالجة هذه الصورة واقترح أولاً أنسب تكوين وحجم.
...
**البصمة:** الحرف كصورة · طباعة تفكيكية · محيط نقطي · شعر بصري · تدرج كثافة · فراغ نشط
...
|---|---|
| **الناتج** | ملصق تجريبي يبدو موضوعاً من بعيد ونظاماً من الحروف والنقاط عند الاقتراب |
| **البصمة الواضحة** | محيط خارجي واضح، وتدرّج كثافة الحروف، وحروف مدوّرة ومكسّرة، وبنى نقطية، وفراغ نشط |
| **احترام المصدر** | يستخرج الكلمات من هوية الموضوع وحركته وبيئته واستعارته لتصبح محيطه وهيكله وظله وملمسه |
...
```text
تحليل الموضوع والمحيط والبنية والوضعية والعلاقة السردية → استخراج كلمات وحروف وعلامات ترقيم ونقاط ذات معنى → إعادة بناء المحيط بالكثافة والحجم والاتجاه والدوران والمسافات والتراكب → تشكيل المناطق الداكنة والوزن بالحروف الكثيفة، والضوء والهواء بالحروف المتناثرة → استخدام محيط نقطي أو حروف شعاعية للبنى المركزية → تحرير قدر قليل من الشظايا داخل الفراغ
```

## سمات النتيجة النهائية

- الحروف ليست شرحاً مضافاً؛ إنها هيكل الموضوع ومحيطه وظله وملمسه. يتقدم الشكل البصري من دون أن يتحول إلى ضجيج عشوائي من الحروف.
- يبقى المحيط الأساسي واضحاً، بينما يمكن للحروف الداخلية أن تتجمع أو تتباعد أو تُرتب رأسياً أو تدور أو تُقلب أو تنقطع أو تتوقف عند حرف واحد.
- يمكن استخدام نقاط متحدة المركز أو حروف شعاعية أو ترتيبات دائرية للحروف في الدوائر والعيون والأضواء والإطارات وقلوب الزهور وفتحات النوافذ والشمس وغيرها من البنى المركزية.
- يتكوّن اللون من حبر حروفي داكن، و1–2 لون بارز مشتق من الأصل، وخلفية شديدة الشحوب وقريبة من الأبيض.
- تجنّب رسومات أحرف ASCII التقليدية، وسحب الكلمات العادية، والإحساس بالكود العشوائي، وأسلوب الخلل السيبراني، والرسوم التوضيحية ذات التخطيط الكامل، وملصقات الطباعة التجارية، والتخطيطات النمطية الجاهزة.

توجد القيود الجمالية فقط في [الموجّه الأصلي](references/original-prompt/zh-CN.md). يعالج الـ Skill ومهايئات التشغيل متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-088-prompt.en.md)
...
/xxd-panel-088 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-088 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-088 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-088 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-088 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 088 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-088 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-088`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-088-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-088-prompt.zh-CN.md)

<!-- xxd-panel-catalog:start -->
## دليل مشاريع XXD Panel الكامل

تم تحديث سلسلة XXD Panel الحالية لتشمل 001–112، ويحتفظ كل Panel بموجّهه الأصلي ومنطقه الجمالي المستقل. الجدول أدناه هو الدليل التاريخي حتى وقت إصدار هذا المشروع؛ يسرد 001–088 بصورة متتابعة، ويظهر المشروع الحالي بخط عريض.
