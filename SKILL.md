...
```text
/xxd-panel-088 <source-or-directory> --mode top-bottom,design-only \
...
1. 上下对照（原图在上，088 设计在下）
2. 左右对照（原图在左，088 设计在右）
...
```text
~/Desktop/xxd/xxd-panel-088/<fresh-task>/
...
- `references/xxd-panel-088-prompt.zh-CN.md`
- `references/xxd-panel-088-prompt.en.md`
